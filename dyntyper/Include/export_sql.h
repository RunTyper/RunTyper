...
void init_sql_con() {
    SQL_HOST = getenv("DYN_TYPER_SQL_HOST");
    SQL_UNAME = getenv("DYN_TYPER_SQL_UNAME");
    SQL_PASSWD = getenv("DYN_TYPER_SQL_PASSWD");
    SQL_DB = getenv("DYN_TYPER_SQL_DB");
    SQL_PORT = atoi(getenv("DYN_TYPER_SQL_PORT"));
